...
128-bit transactions when the block shape and alignment allow, and tl.dot maps
to tensor cores. So there is nothing to change for the "vectorized" step -- the
same kernel is the fair comparison point.
